			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="right text-right">
						...
						<span class="disabled">send message to librarian</span>
					</div>
				</div>
			</div>
					...
					<table class="table table-bordered table-striped">
						...
						if (isset($_POST["submit"])) {
							...
							if ($title == "" | $msg == "") {
								...
								$sql = mysqli_query($link, "insert into tbl_messages values('','$_SESSION[username]','$_POST[rusername]','$_POST[title]','$_POST[msg]','n','$time') ");
