            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="right text-right">
                        ...
                        <span class="disabled">librarian issue book</span>
                    </div>
                </div>
            </div>
            <div class="issueBook">
                        ...
                        <div class="issue-wrapper">
                            <form action="" class="form-control" method="post" name="idn">
                                <table class="table">
                                    <tr>
                                        <td class="">
                                            <select name="idn_select" id="" class="form-control">
                                                <?php 
                                                    $res= mysqli_query($link, "select idno, username from tbl_librarians");
                                                    while($row=mysqli_fetch_array($res)){
                                                        echo "<option>";
                                                        echo $row["idno"] . " (" . $row["username"] . ")";
                                                        echo "</option>";
                                                    }
                                                ?>
                                            </select>
                                ...
                                <?php 
                                    if (isset($_POST["submit1"])) {
                                        $res5 = mysqli_query($link, "select * from tbl_librarians where idno='$_POST[idn_select]' ");
                            ...
                            <?php
                                if (isset($_POST["submit2"])) {
                                    ...
                                    if ($qty==0) {
                                        ...
                                        mysqli_query($link, "insert into tbl_teacher_issues values('','$_SESSION[utype]','$_SESSION[idno]','$_POST[name]','$_POST[phone]','$_POST[email]','$_POST[booksname]','$_POST[booksissuedate]','$_POST[booksreturndate]','$_SESSION[tusername]') ");
