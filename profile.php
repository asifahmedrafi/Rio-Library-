				...
				<div class="profile-content">
					<div class="row">
						<div class="col-md-3">
							<div class="photo">
								<?php
                                    $res = mysqli_query($link, "select * from tbl_admins where username='".$_SESSION['username']."'");
                            ...
                            <?php 
                                if (isset($_POST["submit"])) {
                                    ...
                                    mysqli_query($link, "update tbl_admins set photo='".$imagepath."' where username='".$_SESSION['username']."'");
						...
						<div class="col-md-7 ml-30">
							<div class="details">
								<?php
                                   $res5 = mysqli_query($link, "select * from tbl_admins where username='$_SESSION[username]' ");
                            ...
                            <?php
                               if (isset($_POST["update"])){
                                   mysqli_query($link, "update tbl_admins set 
                                   name='$_POST[name]',
                                   phone='$_POST[phone]',
