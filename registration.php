...
<body>
    <div class="registration">
        <div class="reg-wrapper">
            ...
            <div class="reg-body">
                <h4 style="text-align: center; margin-bottom: 25px;">Admin registration form</h4>
			...
			<?php 
                if (isset($_POST["submit"])) {
                    ...
                    mysqli_query($link, "insert into tbl_admins values('','$_POST[name]','$_POST[username]','$_POST[password]','$_POST[email]','$_POST[phone]','$_POST[address]','$photo','')");
                    ?>
